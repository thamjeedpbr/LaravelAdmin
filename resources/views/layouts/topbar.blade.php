                            ...
                            <div class="row g-0">
                                <div class="col">
                                    <a class="dropdown-icon-item" href="{{ route('users.index') }}">
                                        <img src="{{ URL::asset('assets/images/brands/users.png') }}" alt="Github">
                                        <span>Users</span>
                                    </a>
                                </div>
                            </div>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="@if (Auth::user()->avatar != ''){{ URL::asset('images/' . Auth::user()->avatar) }}@else{{ URL::asset('images/user-icon.webp') }}@endif"
                                alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{Auth::user()->name}}</span>
                                <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">{{Auth::user()->roles[0]['display_name']}}</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                       ...
                       {{-- <a class="dropdown-item" href="pages-profile"><i
                        ...
                        <a class="dropdown-item" href="#">
                            ...
                            <span class="align-middle">Valid Till: <b>{{ \Carbon\Carbon::parse(Auth::user()->valid_till)->format('F j, Y') }}</b></span>
                        </a>
                        
                        <a class="dropdown-item" href="#">
                            <i class="mdi mdi-cog-outline text-muted fs-16 align-middle me-1"></i>
                            <span class="align-middle">Token: <b id="token">{{ Auth::user()->token }}</b></span>
                            <button class="btn btn-link text-muted fs-16 align-middle ms-2" onclick="copyToken('{{ Auth::user()->token }}')" title="Copy Token">
