                    ...
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                            <a href="index" class="d-inline-block auth-logo">
                                <img src="{{ URL::asset('assets/images/logo-light.png')}}" alt="" height="90">
                            </a>
                        </div>
                            ...
                            <div class="p-2 mt-4">
                                <form action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('username') is-invalid @enderror" value="" id="username" name="username" placeholder="Enter username">
                                        @error('username')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> Adam. Crafted with <i class="mdi mdi-heart text-danger"></i> by Adam IT Team</p>
                    </div>
                </div>
            </div>
        </div>
