        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">@lang('common.add') @lang('app.user')</h4>
                        ...
                        <form id="form" method="post">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-4 col-md-4">
                                    ...
                                    <input type="number" class="form-control" id="no_of_client" name="no_of_client" required>
                                </div>
                                <div class="col-xxl-4 col-md-4">
    ...
    <script>
        $(document).ready(function() {
            $("#form").submit(function(e) {
                ...
                ajaxRequest('post', '{{ route('users.store') }}', data, $(this),"{{route('users.index')}}");
            });
        });
    </script>
@endsection
