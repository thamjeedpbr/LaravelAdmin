        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Common @lang('app.courses') Content Helper 
                    </h4>
                    <div class="flex-shrink-0">
                        <a href="{{ route('common.course_help_contents.create') }}">
                            ...
                            <table class="table align-middle table-nowrap" id="data-table">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="sort" data-sort="type">Course Type</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#data-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('get.common.course_help_contents') }}',
                    type: 'GET',
                },
