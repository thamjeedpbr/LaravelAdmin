        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">@lang('app.course-notifications')</h4>
                    <div class="flex-shrink-0">
                        <a href="{{route('course_notifications.create')}}">
                            ...
                            <table class="table align-middle table-nowrap" id="data-table">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="sort" data-sort="program_name">Program Name</th>
                                        <th class="sort" data-sort="category">Category</th>
                                        <th class="sort" data-sort="completed_flag">Is Completed</th>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route("get.course_notifications") }}',
                columns: [{
                        data: 'id',
                        name: 'id',
                        visible: false,
