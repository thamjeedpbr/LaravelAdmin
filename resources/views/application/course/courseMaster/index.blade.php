        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">@lang('app.courses')</h4>
                            ...
                            <table class="table align-middle table-nowrap" id="data-table">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="sort" data-sort="course_topic">Course Type</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#form").submit(function(e) {
                ...
                ajaxRequest('post', '{{ route('course_module.save') }}', data, $(this));
            });
