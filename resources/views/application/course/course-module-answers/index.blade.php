...
@section('title')
    @lang('app.course-module-answers')
@endsection
@section('content')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">@lang('app.course-module-answers')</h4>
                    <div class="flex-shrink-0">
                        <a href="{{route('course_module_answers.create')}}">
                            ...
                            <table class="table align-middle table-nowrap" id="data-table">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="sort" data-sort="module_id">Module</th>
                                        <th class="sort" data-sort="maximum_mark">Maximum Mark</th>
                                        <th class="sort" data-sort="answer_string">Answer</th>
                                        <th class="sort" data-sort="valuation_status">Valuation Status</th>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route("get.course_module_answers") }}',
                columns: [{
                        data: 'id',
                        name: 'id',
                        visible: false,
                    ...
                    {
                        data: 'app_ans_active_start_time',
                        name: 'app_ans_active_start_time'
                    },
                    {
                        data: 'app_ans_active_end_time',
